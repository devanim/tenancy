...
CREATE TABLE `payment_methods` (
  ...
  `processing_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `payment_methods_processing_name_unique` (`processing_name`),
  ...
  CONSTRAINT `payment_methods_payment_provider_id_foreign` FOREIGN KEY (`payment_provider_id`) REFERENCES `payment_providers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
